(function() {
	...
	var saml = document.createElement('script'); saml.type = 'text/javascript'; (document.getElementsByTagName('head')[0] ||
...
$(document).ready(function(){
	...
	$('<a id="login-saml-action" href="https://www.openstack.sj.ifsc.edu.br/simplesamlphp/module.php/core/as_login.php?AuthId=idpcafe.ifsc.edu.br&ReturnTo=https://www.openstack.sj.ifsc.edu.br/owncloud/apps/files"></a>').css({
